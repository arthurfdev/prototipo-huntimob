<template>
  <div class="w-full max-w-full overflow-x-hidden">
    <div class="mb-6">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Gerencie lançamentos e captações</p>
    </div>
    ...
    <div v-if="currentTab === 'lancamentos'" class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="p-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ imovel.tipo }} - {{ imovel.codigo }}</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ imovel.endereco }}</p>
...
const mockImoveis = [
  { id: 1, codigo: 'APT-001', tipo: 'Apartamento', endereco: 'Rua das Flores, 123 - Centro', preco: 350000, status: 'Disponível', quartos: 2, banheiros: 2, area: 75, descricao: 'Apartamento moderno no centro', imagem: imagensImoveis[0] || '' },
  { id: 2, codigo: 'CASA-002', tipo: 'Casa', endereco: 'Av. Principal, 456 - Jardim', preco: 550000, status: 'Disponível', quartos: 3, banheiros: 2, area: 120, descricao: 'Casa com quintal', imagem: imagensImoveis[1] || '' },
  { id: 3, codigo: 'APT-003', tipo: 'Apartamento', endereco: 'Rua Nova, 789 - Bairro Novo', preco: 280000, status: 'Reservado', quartos: 1, banheiros: 1, area: 50, descricao: 'Apartamento compacto', imagem: imagensImoveis[2] || '' },
  { id: 4, codigo: 'APT-004', tipo: 'Apartamento', endereco: 'Rua das Palmeiras, 100 - Centro', preco: 420000, status: 'Disponível', quartos: 3, banheiros: 2, area: 95, descricao: 'Apartamento amplo com varanda', imagem: imagensImoveis[3] || '' },
  { id: 5, codigo: 'CASA-005', tipo: 'Casa', endereco: 'Av. dos Bandeirantes, 200 - Jardim América', preco: 680000, status: 'Disponível', quartos: 4, banheiros: 3, area: 180, descricao: 'Casa espaçosa com piscina', imagem: imagensImoveis[4] || '' },
  { id: 6, codigo: 'TER-006', tipo: 'Terreno', endereco: 'Rua Verde, 50 - Chácara', preco: 250000, status: 'Disponível', quartos: 0, banheiros: 0, area: 500, descricao: 'Terreno plano e regular', imagem: imagensImoveis[5] || '' },
  { id: 7, codigo: 'APT-007', tipo: 'Apartamento', endereco: 'Rua das Acácias, 300 - Centro', preco: 380000, status: 'Disponível', quartos: 2, banheiros: 2, area: 80, descricao: 'Apartamento com vista', imagem: imagensImoveis[6] || '' },
  { id: 8, codigo: 'CASA-008', tipo: 'Casa', endereco: 'Av. Central, 150 - Vila Nova', preco: 520000, status: 'Vendido', quartos: 3, banheiros: 2, area: 140, descricao: 'Casa em condomínio fechado', imagem: imagensImoveis[7] || '' },
  { id: 9, codigo: 'COM-009', tipo: 'Comercial', endereco: 'Rua Comercial, 80 - Centro', preco: 450000, status: 'Disponível', quartos: 0, banheiros: 2, area: 120, descricao: 'Sala comercial bem localizada', imagem: imagensImoveis[8] || '' },
]
