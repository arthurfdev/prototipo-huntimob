<template>
  <div class="w-full max-w-full overflow-x-hidden">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <input
            ...
            class="w-full px-4 py-2 border border-gray-300 dark:border-brand-navy-dark rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-brand-navy-dark dark:text-white"
            @input="handleSearch"
          />
        </div>
        <div>
    ...
    <div class="glass-card-light dark:glass-card rounded-lg shadow overflow-hidden">
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-brand-navy-dark">
          ...
          <tbody class="bg-white dark:bg-brand-navy divide-y divide-gray-200 dark:divide-brand-navy-dark">
            <tr v-for="cliente in paginatedClientes" :key="cliente.id" class="hover:bg-gray-50 dark:hover:bg-brand-navy-dark">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span v-if="cliente.objetivo" class="inline-flex items-center">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                <div class="flex items-center justify-center space-x-2">
                  <button @click="openEditModal(cliente)" class="text-blue-600 hover:text-blue-900 dark:text-blue-400">
                    <PencilIcon class="h-5 w-5" />
                  </button>
                  <button @click="confirmDelete(cliente)" class="text-red-600 hover:text-red-900 dark:text-red-400">
      ...
      <!-- Paginação -->
      <div class="bg-white dark:bg-brand-navy px-4 py-3 border-t border-gray-200 dark:border-brand-navy-dark sm:px-6">
